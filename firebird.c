...
firebird_xpb_zmap database_info_zmap = XPB_ZMAP_INIT(
    ((const char []){
        ...
        isc_info_page_size, isc_info_num_buffers, isc_info_limbo, isc_info_current_memory, isc_info_max_memory,
    ...
    ((const char *[]){
        ...
        "page_size", "num_buffers", "limbo", "current_memory", "max_memory",
