...
// 	zval *link_id, firebird_connection **ib_link, firebird_trans **trans)
// {
...
// 	*trans = NULL;
// 	*ib_link = (firebird_connection *)zend_fetch_resource2_ex(link_id, LE_LINK, le_link, le_plink);
// }
/* }}} */

/* destructors ---------------------- */

// static void _php_firebird_commit_link(firebird_connection *link) /* {{{ */
// {
...
// {
// 	firebird_connection *link = (firebird_connection *) rsrc->ptr;
