...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Database_connect, 0, 1, FireBird\\Database, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Database_get_info, 0, 0, FireBird\\Db_Info, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_FireBird_Database_disconnect, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Database_reconnect_transaction, 0, 1, FireBird\\Transaction, 0)
	ZEND_ARG_TYPE_INFO(0, id, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_FireBird_Database_get_limbo_transactions, 0, 1, IS_ARRAY, 0)
...
#define arginfo_class_FireBird_Service___construct arginfo_class_FireBird_Database___construct

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Service_connect, 0, 1, FireBird\\Service, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Service_get_server_info, 0, 0, FireBird\\Server_Info, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_FireBird_Service_get_db_info, 0, 0, FireBird\\Server_Db_Info, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_FireBird_Service_get_users, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_FireBird_Service_add_user, 0, 1, IS_VOID, 0)
	ZEND_ARG_OBJ_INFO(0, user_info, FireBird\\\125ser_Info, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_FireBird_Service_modify_user arginfo_class_FireBird_Service_add_user

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_FireBird_Service_delete_user, 0, 1, IS_VOID, 0)
...
#define arginfo_class_FireBird_TBuilder_dump_state arginfo_class_FireBird_Database_disconnect
...
static const zend_function_entry class_FireBird_Service_methods[] = {
	ZEND_ME(FireBird_Service, __construct, arginfo_class_FireBird_Service___construct, ZEND_ACC_PRIVATE)
	ZEND_ME(FireBird_Service, connect, arginfo_class_FireBird_Service_connect, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	ZEND_ME(FireBird_Service, get_db_info, arginfo_class_FireBird_Service_get_db_info, ZEND_ACC_PUBLIC)
	ZEND_ME(FireBird_Service, get_users, arginfo_class_FireBird_Service_get_users, ZEND_ACC_PUBLIC)
...
static zend_class_entry *register_class_FireBird_Service(void)
{
	...
	zend_declare_typed_property(class_entry, ZSTR_KNOWN(ZEND_STR_ARGS), &property_args_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_CLASS(property_args_class_FireBird_Service_Connect_Args, 0, 0));
...
static zend_class_entry *register_class_FireBird_Server_Db_Info(void)
{
	...
	zval property_databases_default_value;
	ZVAL_UNDEF(&property_databases_default_value);
	zend_string *property_databases_name = zend_string_init("databases", sizeof("databases") - 1, true);
	zend_declare_typed_property(class_entry, property_databases_name, &property_databases_default_value, ZEND_ACC_PUBLIC, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_ARRAY));
	zend_string_release_ex(property_databases_name, true);

	return class_entry;
}

static zend_class_entry *register_class_FireBird_User_Info(void)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "FireBird", "User_Info", NULL);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, 0);
...
static zend_class_entry *register_class_FireBird_Fb_Error(void)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "FireBird", "Fb_Error", NULL);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, 0);
...
static zend_class_entry *register_class_FireBird_Fb_Exception(zend_class_entry *class_entry_Exception)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "FireBird", "Fb_Exception", NULL);
	...
	zend_declare_typed_property(class_entry, property_sqlstate_name, &property_sqlstate_default_value, ZEND_ACC_PUBLIC|ZEND_ACC_READONLY, NULL, (zend_type) ZEND_TYPE_INIT_MASK(MAY_BE_STRING));
